  ...
  errorComponent: ({ error }) => (
    <main className="min-h-screen flex items-center justify-center p-6">
      <div className="max-w-md panel p-6 text-sm">
        <div className="font-medium text-destructive mb-2">无法加载此授权请求</div>
  ...
  return (
    <main className="min-h-screen flex items-center justify-center p-6">
      <div className="w-full max-w-md panel p-8 space-y-5">
        ...
        <div>
          <h1 className="text-2xl font-semibold">将 {clientName} 连接到你的 Sentinel OS 账号</h1>
          <p className="text-sm text-muted-foreground mt-2">
            允许后，{clientName} 可以以你的身份调用 Sentinel OS 的 MCP 工具， 读取和创建你的 Agent
            任务、MCP 连接与已导入资源。
          </p>
        </div>
