...
import desktopClipboardGetTool from "./tools/desktop/clipboard-get";
import desktopClipboardSetTool from "./tools/desktop/clipboard-set";
...
export default defineMcp({
  ...
  tools: [
    ...
    desktopScrollTool,
    desktopDragTool,
    desktopClipboardGetTool,
    desktopClipboardSetTool,
    desktopLaunchTool,
    desktopWaitTool,
  ],
});
